...
# Note: After beginning with the modeling stage I realised for some models the goal written in the line above isn't possible so I'm staying with the second set only which is the one I used for PCA.
